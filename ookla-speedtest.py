...
try:
    ...
    def to_utf8(v):
        """Encode 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e to utf-8 if possible for py2"""
        try:
...
class Speedtest(object):
    ...
    def download(self, callback=do_nothing, threads=None):
        ...
        A ``threads`` 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e of ``None`` will fall back to those dictated
...
def parse_args():
    ...
    parser.add_argument('--bytes', dest='units', action='store_const',
                        ...
                        help='Display 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑es in bytes instead of bits. Does '
