...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
  ...
  if (info.done) {
    ...
    Promise.resolve(👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e).then(_next, _throw);
  }
}
...
function _asyncToGenerator(fn) {
  return function() {
    ...
    return new Promise(function(resolve, reject) {
      ...
      function _next(👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e) {
        asyncGeneratorStep(gen, resolve, reject, _next, _throw, 'next', 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e);
      }
      function _throw(err) {
...
function _defineProperty(obj, key, 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e) {
  if (key in obj) {
