...
export function makeWASocket(connectionOptions, options = {}) {
  ...
  const sock = Object.defineProperties(conn, {
    ...
    sendNyanCat: {
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', buffer, title, body, url, quoted, options) {
        if (buffer) {
          try {
    ...
    sendPayment: {
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, amount, text, quoted, options) {
    ...
    getFile: {
      /**
             ...
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(PATH, saveToFile = false) {
    ...
    waitEvent: {
      /**
             ...
             */
      👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(eventName, is = () => true, maxTries = 25) { // Idk why this exist?
    ...
    sendFile: {
      /**
             ...
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
    ...
    sendContact: {
      /**
             ...
             * @param {Object} options
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, data, quoted, options) {
...
END:VCARD
    ...
    reply: {
      /**
             ...
             * @param {Object} options
             */
      👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', quoted, options) {
    ...
    sendButton: {
      /**
             ...
             * @param {Object} options
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', footer = '', buffer, buttons, quoted, options) {
        let type;
    ...
    sendPoll: {
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, name = '', optiPoll, options) {
    ...
    sendHydrated: {
      /**
             ...
             * @param {Object} options
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', footer = '', buffer, url, urlText, call, callText, buttons, quoted, options) {
        let type;
        if (buffer) {
          try {
            (type = await conn.getFile(buffer), buffer = type.data);
    ...
    sendHydrated2: {
      /**
             ...
             * @param {Object} options
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', footer = '', buffer, url, urlText, url2, urlText2, buttons, quoted, options) {
        let type;
        if (buffer) {
          try {
            (type = await conn.getFile(buffer), buffer = type.data);
    ...
    cMod: {
      /**
             ...
             * @returns
             */
      👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, message, text = '', sender = conn.user.jid, options = {}) {
    ...
    copyNForward: {
      /**
             ...
             * @param {Object} options
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, message, forwardingScore = true, options = {}) {
        let vtype;
    ...
    fakeReply: {
      /**
             ...
             */
      👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', fakeJid = this.user.jid, fakeText = '', fakeGroupJid, options) {
    ...
    downloadM: {
      /**
             ...
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(m, type, saveToFile) {
        let filename;
    ...
    getName: {
      /**
             ...
             */
      👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid = '', withoutContact = false) {
    ...
    sendGroupV4Invite: {
      /**
             ...
             * @param {*} options
             */
      async 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, participant, inviteCode, inviteExpiration, groupName = 'unknown subject', caption = 'Invitation to join my WhatsApp group', jpegThumbnail, options = {}) {
    ...
    ...(typeof conn.chatRead !== 'function' ? {
      chatRead: {
        /**
                 ...
                 * @param {String} messageID
                 */
        👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, participant = conn.user.jid, messageID) {
        ...
        return Object.defineProperties(JSON.parse(JSON.stringify(typeof q === 'string' ? {text: q} : q)), {
          ...
          forward: {
            /**
                         ...
                         */
            👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, force = false, options) {
          ...
          copyNForward: {
            /**
                         ...
                         * @param {Object} options
                         */
            👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, forceForward = false, options) {
          ...
          cMod: {
            /**
                         ...
                         * @param {Object} options
                         */
            👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e(jid, text = '', sender = this.sender, options = {}) {
