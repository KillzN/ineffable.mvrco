...
const imageSetter = (img, 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e) => img.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e);
const textSetter = (el, 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e) => el.textContent = 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e;
...
const genSVG = async ({
  ...
  for (const [selector, set, 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e] of Object.👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑es(el)) {
    set(svg.querySelector(selector), 👑 𝗞𝗜𝗟𝗟𝗭𝗡 👑e);
  }
